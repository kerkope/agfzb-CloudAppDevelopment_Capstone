...
def registration_request(request):
    ...
    context = {}
    if request.method == 'GET':
        registration_view = render(request, 'djangoapp/signup.html')
        ...
        if not user_exist:
            user = User.objects.create_user(username=username,
                                            ...
                                            password=password)
            login(request, user)
            registration_view = render(request, 'djangoapp/home.html', context)
        else:
            registration_view = render(request, 'djangoapp/signup.html')
...
def get_dealerships(request):
    ...
    if request.method == "GET":
        ...
        get_dealerships_view = render(request, 'djangoapp/home.html', context)
